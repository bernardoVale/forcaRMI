...
public class LoginViewImpl extends JFrame implements LoginView{
	...
	public LoginViewImpl() {
        ...
        btJogar.setIcon(new ImageIcon(LoginViewImpl.class.getResource("/resources/BOTAO_NORMAL.png")));
         btJogar.setPressedIcon(new ImageIcon(getClass().getResource("/BOTAO_ON_FOCUS.png")));// NOI18N

        lbNome.setIcon(new ImageIcon(LoginViewImpl.class.getResource("/resources/LabelNome.png"))); // NOI18N
        lbNome.setName("lbName"); // NOI18N

        jtfJogar1.setFont(new Font("Tahoma", 0, 36)); // NOI18N
        jtfJogar1.setName("jtfNome"); // NOI18N

        lbSenha.setIcon(new ImageIcon(LoginViewImpl.class.getResource("/resources/label_Senha.png"))); // NOI18N
        ...
        jLabel1.setIcon(new ImageIcon(LoginViewImpl.class.getResource("/resources/forca.png"))); // NOI18N
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = GridBagConstraints.BOTH;
